...
def split_mismatch(
    ...
    refer to `the relevant docs <http://vapoursynth.com/doc/functions/video/splice.html>`_.
    Additionally, it splits variable framerate subclips as well.
